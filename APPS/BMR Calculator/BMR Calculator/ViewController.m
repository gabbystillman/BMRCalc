...
- (IBAction)myGenderSwitch:(id)sender {
    NSInteger selectedStatementIndex = self.myOutlet.selectedSegmentIndex;
    Subject* subject = [Subject sharedSubject];
    ...
    //NSString * segmentTitle= [self.myOutlet titleForSegmentAtIndex:selectedStatementIndex];
    /*self.myOutlet.text= segmentTitle;
    
    if(segmentTitle compare: initWithString:"Male")
         Subject* maleSubject=[[Subject sharedSubject] ];
         maleSubject._isMale= YES;
        */
   // }
